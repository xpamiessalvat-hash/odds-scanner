...
print("PAPER TEST | NO APOSTES REALS | NO TELEGRAM / NO GOOGLE SHEETS", flush=True)
print("", flush=True)

cycle = 0

print('🎯 TEST REAL #1 | STEAM + VALUE | PAPER TEST | AUTÒNOM', flush=True)
